...
import WorkspaceGovernanceRectification from '@/components/workspace/WorkspaceGovernanceRectification.vue'
import WorkspaceSpecialPlans from '@/components/workspace/WorkspaceSpecialPlans.vue'
    ...
    >
      <div class="workspace-page">
        ...
        <main class="workspace-main">
          ...
          />
          <WorkspaceGovernanceRectification
            v-else-if="activeNav === 'governance-rectification'"
          />
          <WorkspaceSpecialPlans
            v-else-if="activeNav === 'special-plans'"
          />
          <WorkspaceReview
